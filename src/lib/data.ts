...
export const skills = [
  { name: "JavaScript",            category: "Frontend",           videoUrl: "/skill-videos/javascript.mp4" },
  { name: "TypeScript",            category: "Frontend",           videoUrl: "/skill-videos/typescript.mp4" },
  ...
  { name: "HTML / CSS",            category: "Frontend",           videoUrl: "/skill-videos/html-css.mp4" },
  { name: "Tailwind CSS",          category: "Frontend",           videoUrl: "/skill-videos/tailwind-css.mp4" },
  { name: "Vite",                  category: "Frontend",           videoUrl: "/skill-videos/vite.mp4" },
  { name: "Electron",              category: "Frontend",           videoUrl: "/skill-videos/electron.mp4" },
  { name: "Node.js",               category: "Backend",            videoUrl: "/skill-videos/nodejs.mp4" },
  { name: "Express",               category: "Backend",            videoUrl: "/skill-videos/express.mp4" },
  { name: "Supabase",              category: "Backend",            videoUrl: "/skill-videos/supabase.mp4" },
  { name: "PostgreSQL",            category: "Backend",            videoUrl: "/skill-videos/postgresql.mp4" },
  { name: "MongoDB",               category: "Backend",            videoUrl: "/skill-videos/mongodb.mp4" },
  { name: "REST APIs",             category: "Backend",            videoUrl: "/skill-videos/rest-apis.mp4" },
  { name: "Webhooks",              category: "Backend",            videoUrl: "/skill-videos/webhooks.mp4" },
  { name: "WebSockets",            category: "Backend",            videoUrl: "/skill-videos/websockets.mp4" },
  { name: "Claude API",            category: "AI / Integrations",  videoUrl: "/skill-videos/claude-api.mp4" },
  { name: "GitHub App API",        category: "AI / Integrations",  videoUrl: "/skill-videos/github-app-api.mp4" },
  { name: "n8n",                   category: "AI / Integrations",  videoUrl: "/skill-videos/n8n.mp4" },
  { name: "AI Pipeline Design",    category: "AI / Integrations",  videoUrl: "/skill-videos/ai-pipeline-design.mp4" },
  { name: "Git / GitHub",          category: "Tools",              videoUrl: "/skill-videos/git-github.mp4" },
  { name: "Docker",                category: "Tools",              videoUrl: "/skill-videos/docker.mp4" },
  { name: "AWS",                   category: "Tools",              videoUrl: "/skill-videos/aws.mp4" },
  { name: "CI/CD",                 category: "Tools",              videoUrl: "/skill-videos/ci-cd.mp4" },
  { name: "Vitest",                category: "Tools",              videoUrl: "/skill-videos/vitest.mp4" },
  { name: "Serial Communication",  category: "Hardware / Systems", videoUrl: "/skill-videos/serial-communication.mp4" },
  { name: "USB HID",               category: "Hardware / Systems", videoUrl: "/skill-videos/usb-hid.mp4" },
  { name: "Real-time Event Systems", category: "Hardware / Systems", videoUrl: "/skill-videos/real-time-event-systems.mp4" },
  { name: "State Machine Design",  category: "Hardware / Systems", videoUrl: "/skill-videos/state-machine-design.mp4" },
];
